...
class User(AbstractUser):
    ...
    framework_x = models.ForeignKey(Framework, on_delete=models.CASCADE, related_name="framework_x")
    framework_y = models.ForeignKey(Framework, on_delete=models.CASCADE, related_name="framework_y")
    occupancy = models.ForeignKey(Occupancy, on_delete=models.CASCADE, related_name="occupancy")
